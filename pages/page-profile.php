...
<div class="lg:pl-20 mt-4">
  <div class="max-w-xs px-2.5 lg:max-w-none mx-auto">
    <img
      ...
      decoding="async"
      data-nimg="1"
      class="aspect-square rotate-3 rounded-2xl bg-zinc-100 object-cover dark:bg-zinc-800 mx-auto"
      sizes="(min-width: 1024px) 32rem, 20rem"
      src="http://blog.local/wp-content/uploads/2023/09/image-profile.png"
            ...
            <div class="space-y-10 lg:pl-16 xl:pl-24">
              ...
              >
                ...
                <ol class="mt-6 space-y-4">
                  <li class="flex gap-4">
                    <div
                      class="relative mt-1 flex h-10 w-10 flex-none items-center bg-white justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0"
                    >
                      <img
                        alt=""
                        loading="lazy"
                        ...
                        data-nimg="1"
                        class="h-7 w-7"
                        src="https://resume.amiearth.com/assets/images/logos/mulberrysoft.png"
                        style="color: white"
                      />
                    </div>
                ...
                <a
                  ...
                  target="_blank"
                  href="https://drive.google.com/file/d/10FYMI1LgMOnPx7Z9gD-l2dCGVrUKiHN1/view"
                  >Download CV<svg
                    viewBox="0 0 16 16"
                    fill="none"
                    aria-hidden="true"
